          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:transform-none"
              >
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:kmkryz@gmail.com" className="text-blue-600 hover:text-blue-700">
                    kmkryz@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+12039097894" className="text-blue-600 hover:text-blue-700">
                    +1 (203) 909-7894
                  </a>
                </div>
              </div>
